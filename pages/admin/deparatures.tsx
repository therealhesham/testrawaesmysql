            ...
            <table className="min-w-full text-sm text-left">
              <thead className="bg-teal-800">
                <tr className="text-white">
                  ...
                  <th className="px-4 py-2 text-center">رقم الجواز</th>
                  <th className="px-4 py-2 text-center">من</th>
                  <th className="px-4 py-2 text-center">الى</th>
                  <th className="px-4 py-2 text-center">سبب المغادرة</th>
                  <th className="px-4 py-2 text-center">تاريخ المغادرة</th>
                  <th className="px-4 py-2 text-center">تاريخ الوصول</th>
                </tr>
              </thead>
                ...
                {data.length === 0 ? (
                  ...
                  data.map((item) => (
                    <tr key={item.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2 text-center text-gray-600">
                        {item.Order.HomeMaid?.office?.Country}
                      </td>
                      <td className="px-4 py-2 text-center text-gray-600">
                      ...
                      <td className="px-4 py-2 text-center text-gray-600">
                        {item?.finaldestination ? item?.reason : "لا يوجد سبب"}
                      </td>
                      <td className="px-4 py-2 text-center text-gray-600">
                        {getDate(item.deparatureDate)}
                      </td>
                      <td className="px-4 py-2 text-center text-gray-600">
                        {item.finalDestinationDate}
                      </td>
                    </tr>
                  ))
                )}
