      ...
      clientDeliveries.forEach((delivery) => {
        ...
        try {
          ...
          if (timeDiff > 0 && timeDiff <= twoHoursInMs) {
            ...
            const clientName = delivery.neworder?.client?.fullname || delivery.neworder?.ClientName || delivery.neworder?.HomeMaid?.Name || delivery.neworder?.Name || 'غير محدد';
                      ...
                      {hasDeliveries && deliveriesForDay.map((delivery, deliveryIndex) => {
                        ...
                        return (
                          <div 
                            ...
                            title={`تسليم: ${delivery.neworder?.client?.fullname || delivery.neworder?.ClientName || delivery.neworder?.HomeMaid?.Name || delivery.neworder?.Name || 'غير محدد'}${timeString}`}
                          >
