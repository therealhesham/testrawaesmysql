...
function DashboardClient(props) {
  ...
  const post = async () => {
    setData([]);
    setStatus(true);
    const fetcher = await fetch("../api/filterdataforclient", {
      method: "post",
      headers: {
    ...
    const filteringData = waiter?.filter((e) => {
      return (
        e.fields["age - العمر"] > value[0] && e.fields["age - العمر"] < value[1]
      );
    });
  ...
  return (
    <div style={{ backgroundColor: "whitesmoke", minHeight: "100vh" }}>
      {media ? (
        <div className="navbar   bg-gray-50 dark:bg-gray-800 shadow-lg ">
              ...
              {user.isUser ? (
                ...
                >
                  ...
                  <li className="btn btn-ghost text-l">
                    <Link href="/client/status">طلباتي</Link>
                  </li>
                  <li className="btn btn-ghost text-l">
                    <a>نبذة عننا</a>
                  </li>
                  <li
                    className="btn btn-ghost text-l"
                    style={{ backgroundColor: "#003749", color: "whitesmoke" }}
                    onClick={() => {
                ...
                >
                  <li
                    className={"btn btn-ghost text-l" + Style["almarai-bold"]}
                    onClick={() => router.push("/client")}
                  >
                    الرئيسية
                  </li>
          ...
          <div className="navbar-center">
            <a className="btn btn-ghost text-xl">
              <img
                style={{ width: "70px", height: "50px", justifySelf: "center" }}
        ...
        <nav
          dir="ltr"
          style={{ position: "sticky", zIndex: +1, height: "70px" }}
          className={
            "flex  justify-between px-6 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 shadow-lg"
          }
        >
          {/* <div className="" style={{}}>  */}
          <img
          ...
          <a className="text-gray-700 dark:text-gray-400" href="#"></a>
          {user.isUser == true ? (
            <ul className="flex space-x-4">
              ...
              <Link href="/client/status">
                <li className="btn btn-ghost text-l">طلباتي</li>
              </Link>
            ...
            <ul className={"flex justify-between flex items-center space-x-4"}>
              ...
              <li
                className="btn btn-ghost text-l hover:shadow-[rgba(0,0,0,0.5)_0px_0px_10px_0px]"
                style={{
                  fontFamily: "Almarai",
                  fontWeight: 800,
                  fontStyle: "normal",
              ...
              <li
                onClick={() => router.push("/client")}
                className={
                  "btn btn-ghost text-l hover:shadow-[rgba(0,0,0,0.5)_0px_0px_10px_0px]"
                }
                style={{
                  fontFamily: "Almarai",
                  fontWeight: 800,
      ...
      />
        ...
        <div style={{ display: "grid", gridTemplateRows: media ? "100%" : "" }}>
          ...
          >
            ...
            <Label>
              ...
              >
                ...
                <option value="Philippines - الفلبين">الفلبين</option>

                <option value="Kenya - كينيا">كينيا</option>

                <option value="Ethiopia - إثيوبيا">إثيوبيا</option>

                <option value="Uganda - أوغندا">أوغندا</option>
                <option value="Pakistan - باكستان">باكستان</option>
              </Select>
            </Label>
          ...
          <Modal isOpen={isModalOpen} onClose={closeModal}>
            ...
            <ModalBody>لا يوجد بيانات متعلقة بهذا البحث</ModalBody>
            <ModalFooter>
              <Button
          ...
          {!filtering ? (
            ...
            <p
              ...
              className={Style["almarai-bold"]}
            >
              نتائج البحث {data.length} سيرة ذاتية{" "}
            </p>
          )}
          ...
          <div
            ...
            style={{
              ...
              borderRadius: "12px",
              display: media ? "grid" : "grid",
              marginTop: "10px",
              justifyContent: "center",
              gridTemplateColumns: media ? "repeat(1, 90%)" : "repeat(2, 40%)",
            }}
          >
            {props.waiter.map((e, i) => (
              <div
                ...
                key={i}
                className="card card-compact card-side w-100 bg-base-100 shadow-xl"
...
>
    ...
    <ShareAltOutlined  />
                ...
                <div className="card-body" style={{}}>
                  ...
                  >
                    ...
                    >
                      {Math.ceil(
                        dayjs(new Date()).diff(
                          e.fields["date of birth - تاريخ الميلاد"]
                        ) / 31556952000
                      )}{" "}
                    </li>
                    <li
                  ...
                  >
                    <div
                      onClick={() => router.push("../client/book/" + e.id)}
                    ...
                    >
                      ...
                      <span
                        ...
                        onClick={() =>
                          router.push("../client/cvdetails/" + e.id)
                        }
                      >
                        التفاصيل
                      </span>
      ...
      <div>{/* <footer style={{bottom:1}}>asdasdasda</footer> */}</div>
    </div>
  );
}
//
...
export async function getServerSideProps() {
  ...
  const fetcher = await fetch("http://localhost:3000/api/listfifty", {
    method: "get",
  });
  const waiter = await fetcher.json();
  return { props: { waiter } };
