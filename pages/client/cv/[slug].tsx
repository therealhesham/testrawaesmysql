...
"Expert - ممتاز"]
return (   
<div style={{backgroundColor:"whitesmoke",display:media?"grid":"",justifyItems:media?"center":"",height:"100vh"}}>
...
data.fields["laundry - الغسيل"] == e?<Rating  name="half-rating"  defaultValue={i+1} disabled style={{opacity:"100%"}} />:console.log(e)
        

        )}</div>
        <div>
  <h4>الكوي</h4>  {rates.map((e,i)=>
data.fields["Ironing - كوي"] == e?<Rating  name="half-rating" defaultValue={i+1} disabled style={{opacity:"100%"}} />:console.log(e)
        

        )}</div>
        <div>
 <h4>التنظيف</h4>  {rates.map((e,i)=>
data.fields["cleaning - التنظيف"] == e?<Rating  name="half-rating" defaultValue={i+1} disabled style={{opacity:"100%"}} />:console.log(e)
...
data.fields["Cooking - الطبخ"] == e?<Rating  name="half-rating" defaultValue={i+1} disabled style={{opacity:"100%"}} />:console.log(e)
...
data.fields["sewing - الخياطة"] == e?<Rating  name="half-rating" defaultValue={i+1}  disabled style={{opacity:"100%"}}/>:console.log(e)
...
<div style={{display:"flex",flexWrap:"wrap",justifyContent:"space-around",alignContent:"space-around",justifyItems:"center",flexDirection:"row",width:"50%"}}><div >  <h4>اللغة العربية</h4>
  {rates.map((e,i)=>
data.fields["Arabic -  العربية"] == e?<Rating   aria-label={e} name="half-rating" defaultValue={i+1}  disabled style={{opacity:"100%"}}/>:console.log(e)
...
<h4>اللغة الانجليزية</h4>
  {rates.map((e,i)=>
data.fields["English - الانجليزية"] == e?<Rating aria-label={e} name="half-rating" defaultValue={i+1} disabled style={{opacity:"100%"}} />:console.log(e)
