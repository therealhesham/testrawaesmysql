...
const templates = [
  {
    ...
    content: getTemplateContent(`
      ...
      <div style="margin-bottom: 8px; display: flex; align-items: baseline; direction: ltr; font-size: 13px;">
        <span style="white-space: nowrap; width: 230px; font-family: Arial, sans-serif; direction: ltr;">For the period from:</span>
        <div style="flex-grow: 1; border-bottom: none; text-align: center; font-weight: bold; margin: 0 10px; font-size: 14px;">
          {period_from} &nbsp; <span style="font-family: Arial, sans-serif; font-weight: normal; font-size: 12px;">to</span> &nbsp; {period_to}
        </div>
        <span style="white-space: nowrap; width: 230px; text-align: right; direction: rtl;">وذلك عن فترة عملي من تاريخ إلى تاريخ:</span>
      </div>
  ...
  },
  {
    ...
    type: "worker_receipt",
    dynamicFields: ["employer_name1","employer_name2","employer_name3","employer_id1","employer_id2","mobile2","worker_name","nationality","passport_number","refund_amount","contract_amount","arrival_date","receive_date","hijri_date","gregorian_date"],
    content: getTemplateContent(`
      ${dateSection}
      ...
      <!-- {contract_amount} {arrival_date} {receive_date} -->
    `)
  },
  {
    title: "عقد نقل خدمات",
    type: "transfer_contract",
    dynamicFields: ["employer_name1","employer_name2","nationality","id_number1","id_number2","mobile1","birth_date","worker_name","worker_nationality","passport_number","trial_days","start_date_h","end_date_h","start_date_g","end_date_g","amount_text","hijri_date","gregorian_date","daily_penalty_amount"],
    content: getTemplateContent(`
      ${dateSection}
      ...
      <div style="font-size: 13px; line-height: 1.4; text-align: justify;">
        ...
        في حال عدم رغبة الطرف الثاني في استمرار العاملة خلال فترة التجربة يلتزم بإعادتها إلى المكتب، مع التزامه بدفع مبلغ وقدره ({daily_penalty_amount} ريال) للعاملة عن كل يوم من أيام التجربة، على أن يتم خصمها من إجمالي المبلغ المدفوع للمكتب.</p>
  ...
  },
  {
    ...
    content: getTemplateContent(`
      ...
      <div style="float: right; width: 220px; text-align: right; margin-bottom: 5px; font-family: 'Amiri', serif; font-size: 11px; margin-top: 15px;">
        <div style="margin-bottom: 2px;"><strong>التاريخ:</strong> {hijri_date} هـ</div>
        <div><strong>الموافق:</strong> {gregorian_date} م</div>
      </div>
      <div style="clear: both;"></div>

      <h2 style="text-align: center; margin: 5px 0 10px 0; font-size: 17px; font-weight: bold;">نموذج طلب استرداد مبلغ للعميل</h2>
